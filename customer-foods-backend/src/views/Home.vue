  ...
  <div>
    ...
    <div class="box has-background-white-bis">
      ...
      <div class="columns table-wrapper">
        <table class="table crud-table customer-foods-table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
          <thead>
          <tr>
          ...
          <tr v-for="(item, cindex) in items">
            <td v-for="header in headers">
              ...
              <span v-else>
                <button class="button is-primary is-outlined" @click="confirmApproval(item)">
                      <span class="icon mdi mdi-check-bold"></span>
                  </button>
                ...
                <div class="field">
                  <p class="control">
                    <input class="input" type="text"
                           placeholder="Nombre"
                           ref="autofocus"
                           v-model="editedItem.description" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                  </p>
                </div>
                ...
                <div class="field">
                  <p class="control  has-icons-right">
                    <input class="input" type="text"
                           ...
                           v-model="editedItem.amount" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                ...
                <div class="field">
                  <p class="control has-icons-right">
                    <input class="input" type="text"
                           ...
                           v-model="editedItem.protein" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                    <span class="icon is-right">gr</span>
                  </p>
                ...
                <div class="field">
                  <p class="control has-icons-right">
                    <input class="input" type="text"
                           ...
                           v-model="editedItem.carbohydrates" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                    <span class="icon is-right">gr</span>
                  </p>
              ...
              <div class="column">
                <div class="field">
                  <p class="control has-icons-right">
                    <input class="input" type="text"
                           placeholder="Grasas"
                           v-model="editedItem.fat" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                    <span class="icon is-right">gr</span>
                  </p>
                ...
                <div class="field">
                  <p class="control has-icons-right">
                    <input class="input" type="text"
                           ...
                           v-model="editedItem.kCalories" :disabled="editedIndex==-2 || editedIndex ==-3"
                           @keypress.enter="save()"
                    >
                    <span class="icon is-right">gr</span>
                  </p>
              ...
              <div class="column">
                <div class="field">
                  <textarea class="textarea"
                            ...
                            v-model="editedItem.comments" :disabled="editedIndex==-2 || editedIndex ==-3"
                            rows="2">
                  </textarea>
                </div>
              </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit A"
                             v-model="editedItem.vitA" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-1"
                             v-model="editedItem.vitB1" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-2"
                             v-model="editedItem.vitB2" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-3"
                             v-model="editedItem.vitB3" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-5"
                             v-model="editedItem.vitB5" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-6"
                             v-model="editedItem.vitB6" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit B-9"
                             v-model="editedItem.vitB9" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.vitB12" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit C"
                             v-model="editedItem.vitC" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit D"
                             v-model="editedItem.vitD" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit E"
                             v-model="editedItem.vitE" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Vit K"
                             v-model="editedItem.vitK" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Colina"
                             v-model="editedItem.choline" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Calcio"
                             v-model="editedItem.calcium" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Cobre"
                             v-model="editedItem.copper" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Hierro"
                             v-model="editedItem.iron" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.magnesium" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.manganese" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Fósforo"
                             v-model="editedItem.phosphorus" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Potasio"
                             v-model="editedItem.potassium" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Selenio"
                             v-model="editedItem.selenium" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Sodio"
                             v-model="editedItem.sodium" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Zinc"
                             v-model="editedItem.zinc" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Agua"
                             v-model="editedItem.water" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                ...
                <div class="column">
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             placeholder="Fibra"
                             v-model="editedItem.fiber" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.cholesterol" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.saturatedFat" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.monoUnsaturatedFat" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.polyUnsaturatedFat" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
                  ...
                  <div class="field">
                    <p class="control">
                      <input class="input" type="text"
                             ...
                             v-model="editedItem.glycemicIndex" :disabled="editedIndex==-2 || editedIndex ==-3"
                             @keypress.enter="save()"
                      >
                    </p>
                  </div>
            ...
            <div class="columns">
              <div class="column">
                ...
                <button v-else class="button is-fullwidth is-success is-active" @click="save()"
                        :class="processing ? 'is-loading' : ''">
                      <span v-if="editedIndex == -3">Aprobar</span>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'Nombre usuario', value: 'display_name'},
      ...
      editedIndex: -1, // -1 for new item, -2 for deleting item, -3 for approval
      editedItem: {
        id: '',
        description: '',
        amount: '',
  ...
  computed: {
    formTitle() {
      switch (this.editedIndex) {
        ...
        case -3:
          return `Aprobar ${this.itemNaming.singular}`;
        default:
  ...
  methods: {
    ...
    confirmApproval(item) {
      this.editedIndex = -3; //code for deleting
      this.editedItem = Object.assign({}, item)
      this.dialog = true;
    },
    close() {
    ...
    save() {
      // -1 for new item, -2 for deleting item, -3 for approval
      // only savers taken into account (delete is handled differently)
      switch (this.editedIndex){
        case -1:
          this.postItem();
          break;
    ...
    getItems() {
      ...
      axiosPostApi('/init_customer_foods',
        {
          term: this.term,
          length: this.length,
          page: this.page
        ...
        res => {
          this.items = res.data.customer_foods.itemsRows;
          this.itemsNumber = res.data.customer_foods.itemsNumber;
          this.pagesNumber = res.data.customer_foods.pagesNumber;
          this.currentPage = res.data.customer_foods.currentPage;
          this.setFooterPages();
    ...
    postItem() {
      this.processing = true;
      axiosPostApi('/customer_food', {"item": this.editedItem}, res => {
    ...
    approveItem(){
      this.processing = true;
      axiosPostApi('/approve_customer_food', {"item": this.editedItem}, res => {
        if (res.data.hasOwnProperty("errors") && res.data.errors.length) {
          this.showNotification("No se pudo aprobar el item", "error");
          this.errors = res.data.errors;
        } else {
          this.close();
          this.getItems();
          this.showNotification('Aprobado correctamente', 'success');
        }
        this.processing = false;
      });
    },
    updateItem() {
      this.processing = true;
      axiosPutApi('/customer_food', {"item": this.editedItem}, res => {
        if (res.data.hasOwnProperty("errors") && res.data.errors.length) {
    ...
    deleteItem() {
      this.processing = true;
      axiosDeleteApi('/customer_food', {"item": this.editedItem}, res => {
        if (res.data.hasOwnProperty("errors") && res.data.errors.length) {
